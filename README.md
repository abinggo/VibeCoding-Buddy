...
### Floating Bubble — Always-on-Top Status
<img src="assets/bubble-working.png" width="40%" alt="Floating bubble showing 1 agent working" />  <img src="assets/bubble-done.png" width="40%" alt="Floating bubble showing 1 agent done" />

> A tiny draggable bubble sits on your desktop. Glance at it to see how many agents are running and whether they're **Working** or **Done**.
...
<img src="assets/notification.png" width="100%" alt="Menu bar showing VB 1 badge and notification dropdown with completed agent" />
...
### 悬浮气泡 — 桌面常驻状态
<img src="assets/bubble-working.png" width="40%" alt="悬浮气泡显示 1 个 Agent 正在工作" />  <img src="assets/bubble-done.png" width="40%" alt="悬浮气泡显示 1 个 Agent 完成" />

> 桌面常驻的可拖拽小气泡，一眼就能看到 Agent 数量和当前状态（**Working** / **Done**）。
...
### 菜单栏消息通知
<img src="assets/notification.png" width="100%" alt="菜单栏显示 VB 1 角标和已完成的 Agent 通知" />
