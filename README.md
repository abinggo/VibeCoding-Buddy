...
- **Arcade corner**: playable mini-games (Space Invaders, Pong, Snake, Tetris), lava lamp, neon "HACK" sign, mini fridge
...
```bash
make bundle    # creates build/Vibe Buddy.app
...
```bash
make bundle    # 生成 build/Vibe Buddy.app
